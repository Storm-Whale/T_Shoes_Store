...
//    CTSP.ID,CTSP.MaCTSP,SP.TenSP,TH.TenThuongHieu,S.TenSize,M.TenMau,CTSP.SoLuongTon, CTSP.GiaBan, CTSP.GiaNiemYet, CTSP.MoTa, CTSP.TrangThai
                ...
                cell6.setCellValue(x.getIdNV().getMaNV());
                
                Cell cell7 = row.createCell(5);
                cell7.setCellValue(x.getIdKH().getMaKH());
                
//                Cell cell8 = row.createCell(6);
//                cell8.setCellValue(x.get()==0? "Tại quầy":"Đặt hàng" );

                Cell cell8 = row.createCell(7);
                cell8.setCellValue(x.setTrangThaiHD(x.getTrangThai())); // Đặt giá trị kiểu dữ liệu phù hợp
//
