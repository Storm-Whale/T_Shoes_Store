...
//    private DefaultTableModel dtm = new DefaultTableModel();
    private final ThuongHieuService mauService = new ThuongHieuService();
    private List<ThuongHieu> listMauSac = new ArrayList<>();
    private int index = -1;
    private ThuongHieu returnMauSac;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Danh Sách Thương Hiệu");

        jPanel1.setBorder(javax.swing.BorderFactory.createEtchedBorder());

        jLabel2.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel2.setText("Mã TH :");
        ...
        tbl_MauSac.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Mã TH", "Tên TH", "Người Tạo", "Trạng Thái"
            }
        ) {
    ...
    private void btn_ThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_ThemActionPerformed
        ...
        ThuongHieu mausac = this.getInputMauSac();
        try {
            if (mauService.addThuongHieu(mausac) != null) {
    ...
    private void btn_SuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_SuaActionPerformed
        // TODO add your handling code here:
        if (index == -1) {
            MsgBox.alert(this, "Vui Long Chon Thuong Hieu");
            return;
        }
        ...
        ThuongHieu mausac = this.getInputMauSac();
        mausac.setIdThuongHieu(listMauSac.get(index).getIdThuongHieu());
        try {
            if (mauService.updateThuongHieu(mausac) != null) {
    ...
    private void btn_TimKiemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_TimKiemActionPerformed
        ...
        dtm.setRowCount(0);
        for (ThuongHieu mauSac : listMauSac) {
            dtm.addRow(new Object[]{
                mauSac.getIdThuongHieu(),
                mauSac.getMaThuongHieu(),
                mauSac.getTenThuongHieu(),
                mauSac.getNguoiTao(),
    ...
    private void setForm(int index) {
        txt_MaMau.setText(listMauSac.get(index).getMaThuongHieu());
        txt_TenMau.setText(listMauSac.get(index).getTenThuongHieu());
    ...
    private ThuongHieu getInputMauSac() {
        ThuongHieu mauSac = new ThuongHieu();
        mauSac.setMaThuongHieu(txt_MaMau.getText());
        mauSac.setTenThuongHieu(txt_TenMau.getText());
    ...
    public ThuongHieu returnSelectedThuongHieu() {
        return returnMauSac;
    }
    ...
    private boolean checkDuplicateAll() {
        if (checkDuplicate(txt_MaMau.getText(), listMauSac, ThuongHieu::getMaThuongHieu)) {
            MsgBox.alert(this, "Trung Ma");
            return true;
        }
        if (checkDuplicate(txt_TenMau.getText(), listMauSac, ThuongHieu::getTenThuongHieu)) {
