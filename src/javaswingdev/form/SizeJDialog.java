...
//    private DefaultTableModel dtm = new DefaultTableModel();
    private final SizeService mauService = new SizeService();
    private List<KichThuoc> listMauSac = new ArrayList<>();
    private int index = -1;
    private KichThuoc returnMauSac;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Danh Sách Kích Thước");

        jPanel1.setBorder(javax.swing.BorderFactory.createEtchedBorder());

        jLabel2.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel2.setText("Mã KT :");

        jLabel3.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel3.setText("Tên KT :");
        ...
        tbl_MauSac.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Mã KT", "Tên KT", "Người Tạo", "Trạng Thái"
            }
        ) {
    ...
    private void btn_ThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_ThemActionPerformed
        ...
        KichThuoc mausac = this.getInputMauSac();
        try {
            if (mauService.addSize(mausac) != null) {
    ...
    private void btn_SuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_SuaActionPerformed
        // TODO add your handling code here:
        if (index == -1) {
            MsgBox.alert(this, "Vui Long Chon Kich Thuoc");
            return;
        }
        ...
        KichThuoc mausac = this.getInputMauSac();
        mausac.setIdSize(listMauSac.get(index).getIdSize());
        try {
            if (mauService.updateSize(mausac) != null) {
    ...
    private void btn_TimKiemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_TimKiemActionPerformed
        ...
        listMauSac = mauService.getToAllKichThuoc(keyword, trangthai);
        DefaultTableModel dtm = (DefaultTableModel) tbl_MauSac.getModel();
        dtm.setRowCount(0);
        for (KichThuoc mauSac : listMauSac) {
    ...
    private void loadDataTable() {
        DefaultTableModel dtm = (DefaultTableModel) tbl_MauSac.getModel();
        dtm.setRowCount(0);
        listMauSac = mauService.getToAllKichThuoc();
        for (KichThuoc mauSac : listMauSac) {
            dtm.addRow(new Object[]{
                mauSac.getIdSize(),
                mauSac.getMaSize(),
    ...
    private void setForm(int index) {
        txt_MaMau.setText(listMauSac.get(index).getMaSize());
        txt_TenMau.setText("" + listMauSac.get(index).getTenSize());
    ...
    private KichThuoc getInputMauSac() {
        KichThuoc mauSac = new KichThuoc();
        mauSac.setMaSize(txt_MaMau.getText());
        mauSac.setTenSize(Float.parseFloat(txt_TenMau.getText()));
    ...
    public KichThuoc returnSelectedKichThuoc() {
        return returnMauSac;
    }
    ...
    private boolean checkValidate() {
        ...
        if (!isNumeric(txt_TenMau.getText())) {
            MsgBox.alert(this, "Vui Long Nhap So");
            return true;
        }

        if (!checkPositive(txt_TenMau.getText())) {
    ...
    private boolean checkDuplicateAll() {
        if (checkDuplicate(txt_MaMau.getText(), listMauSac, KichThuoc::getMaSize)) {
            MsgBox.alert(this, "Trung Ma");
            return true;
        }
        if (checkDuplicate(txt_TenMau.getText(), listMauSac, kichThuoc -> String.valueOf(kichThuoc.getTenSize()))) {
