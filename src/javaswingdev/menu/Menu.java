...
public class Menu extends JPanel {
    ...
    private void init() {
        ...
        addTitle("Quản lý");
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.VIEW_LIST, "Bán Hàng"));
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.VIEW_LIST, "Hóa Đơn"));
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.VIEW_LIST, "Sản Phẩm"));
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.VIEW_LIST, "PGG"));
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.VIEW_LIST, "Nhân Viên"));
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.VIEW_LIST, "Khách Hàng"));
